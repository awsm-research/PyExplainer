...
def test_fried_scale():
    ...
    # winsorised version of first column at trim=0.1: note, will not be scaled because it is already an
    x_scale_test[5:55, 1] = 1
    # indicator function, as per FP004
    fs = FriedScale()
...
def run_all_tests():
    ...
    test_rule_transform()
    test_rule_equality()
    # to be fixed due to signature changed
    # test_fried_scale()
