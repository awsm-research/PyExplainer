...
#         print('generated data to train local model')
#         print(data[0])
#         print('original generated data')
#         print(inverse)
#         print('-'*80)
...
#             print('data is not sparse')
#             print( self.scaler.mean_, self.scaler.scale_)
        ...
        for label in labels:
            (ret_exp.intercept[label],
             ...
             local_model) = self.base.explain_instance_with_data(
                                scaled_data,
                                yss,
                                distances,
                                label,
        ...
        scaled_data = scaled_data[:, selected_feature_indices]
#         inverse = inverse[:, selected_feature_indices]
        
#         print('explain finished')
        
#         synt_label = local_model.predict(final_synt_instance)
        return ret_exp, inverse, scaled_data, selected_feature_indices, local_model
#         return ret_exp
...
#         print('in __data_inverse function()')
#         print(data)
#         print('data row:', data_row.copy())
